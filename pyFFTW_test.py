...
print('built-in scipy.fft (20 iteration over function calls): '+str(timeit.default_timer()-startTime)+' sec');
...
for i in range(iteration):
    ...
    fftw_obj();
print('pyfftw backend (20 iteration over setup+function calls): '+str(timeit.default_timer()-startTime)+' sec')
